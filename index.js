...
client.on("message", async message => {
  ...
  if (message.content.match(prefixMention)) {
    ...
    let embed = new MessageEmbed()
        ...
        :question: Still need help? [Click Here](https://discord.gg/X2XkerN3PQ) to join server
        `)

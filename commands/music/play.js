...
let rowss = new MessageActionRow()
                ...
                if (serverQueue) {
                    ...
                    if (playlist) return undefined;
                        ...
                        const sembed = new MessageEmbed()
                            .setColor("GREEN")
                            .setTitle(":! ToXicツ_Music:> Added To Queue", message.author.displayAvatarURL())
                            .setThumbnail(song.thumbnail)
                            .setTimestamp()
                            .setImage("https://i.ibb.co/DwZQS4R/standard.gif")
                            .setDescription(`**<a:musicbeat:908714985914515456> Title:** [${song.title}](${song.url}) \n\n **<a:loading:881979583577092197>Song Duration:** ${np} minutes \n\n **Status:** Pending`)
  ...
  const serverQueue = ops.queue.get(message.guild.id);
                ...
                const embed = new MessageEmbed()
                    ...
                    .setColor("GREEN")
                    .setTitle(':! ToXicツ_Music:> Song was Ended')
                    .setThumbnail(song.thumbnail)
                    .setTimestamp()
                    .setDescription(`**<a:musicbeat:908714985914515456> Title:** [${song.title}](${song.url}) \n\n **<a:loading:881979583577092197>Song Duration** ${np} minutes \n\n **Status:** **Finished** `)
                    .setFooter(`Played by: ${message.member.displayName} `, message.author.displayAvatarURL());
